                ...
                <div class="container content_wrap">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-between">
                            <h3 class="h3"><button class="btn btn_back" onclick="history.back();"><i class="bi bi-arrow-left"></i></button>연구 회원 등록</h3>
                        ...
                        <div class="col-12">
                            <ul class="list_style_1">
                                ...
                                <li>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="병록번호 입력" id="mtHospitalId">
                                ...
                                <li>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="서비스번호(ID) 입력" id="mtId" autocomplete="new-password">
                                ...
                                <li class="mtDiagnosisClass">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="mtHospitalCode">
                                        	<option value="고려대학교 안암병원" selected>고려대학교 안암병원</option>
                                        	<option value="고려대학교 구로병원">고려대학교 구로병원</option>
                                        	<option value="고려대학교 안산병원">고려대학교 안산병원</option>
                                        	<option value="0">*직접입력</option>
                                        </select>
                                    </div>
                                </li>
                                <li class="mtDiagnosisClass pb-0">
                                    <span></span>
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="병원명 직접입력" id="mtHospital" style="display: none;">
                                ...
                                <li class="mtDiagnosisClass">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="진단의 입력" id="mtDoctor">
                                ...
                                <li class="mtDiagnosisClass">
                                    ...
                                    <div class="form-group calendar">
                                        <input type="text" class="form-control" id="datepicker2" placeholder="yyyy.mm.dd" autocomplete='off'>
                                        <i class="ic_calendar"><img src="${CDN_HTTP }/images/ic_calendar.png" alt="캘린더"></i>
                                ...
                                <li>
                                    ...
                                    <div class="form-group calendar">
                                        <input type="text" class="form-control" id="datepicker3" placeholder="yyyy.mm.dd" autocomplete='off'>
                                        <i class="ic_calendar"><img src="${CDN_HTTP }/images/ic_calendar.png" alt="캘린더"></i>
                                ...
                                <li>
                                    ...
                                    <div class="form-group">
				                        <textarea class="form-control" placeholder="내용 입력" id="mtMemo" name="content"></textarea>                    
				                    </div>
                                </li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="btn_wrap">
                                <div class="btn_wrap">
                                    <button class="btn btn-light mr-3" onclick="location.href='./memberList2'">취소</button>
                                    <button class="btn btn-primary" onclick="open_modal_confirm('해당 신규 연구 회원을 등록할까요?')">등록</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
// 			error_count++
		...
		if(res.result == 'success'){
			console.log(res);
			open_modal_replace(`./memberDetail2?idx=\${res.idx}`, "신규 연구 회원이 등록되었습니다.");
		}else{
			if(res.error_code){
