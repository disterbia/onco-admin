    ...
    <div class="container content_wrap">
        <div class="row">
            <div class="col-12 d-flex justify-content-between">
                <h3 class="h3"><button class="btn btn_back" onclick="history.back();"><i class="bi bi-arrow-left"></i></button>컨텐츠 등록</h3> 
            ...
            <div class="col-12">     
                ...
                <div class="message_body">  
	                    ...
	                    <div class="form-group w-50 ml-2">
	                        ...
	                        <select class="form-control" id="gtIdx" style="min-width:120px;">
	                            ...
	                            <c:forEach var="gene" items="${geneList}">
	                                <option value="${gene.idx}">${gene.gtName}</option>
	                            </c:forEach>
	                        </select>                  
	                    </div>  
					</div>
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ctTitle" placeholder="제목 입력">
                    ...
                    <div class="form-group">
                        <label>동영상 URL</label>
                        <input type="text" class="form-control" id="ctUrl" placeholder="동영상 URL 입력">
                    ...
                    <div class="form-group">
						...
						<label>내용</label>
                        <textarea class="form-control noti_form" placeholder="내용 입력" id="ctContent" name="content" style="height: 120px;"></textarea>            
                    ...
                    <div class="form-group">
                    	...
                    	<div class="chat_input_footer">
		                    ...
		                    <div class="attachment_title my_attachment_title">
		                    </div>
		                    <button type="button" class="d-none btn btn_close my_attachment_xicon" onclick="remove_file(0);">
	                       		<i class="bi bi-x"></i>	
		                    </button>
	                    </div>
                    ...
                    <div class="mt-5">
                        <button class="btn btn-light mr-2" onclick="open_modal_confirm2('컨텐츠 작성을 취소할까요?');">
                            취소
                        </button>
                        <button type="button" class="btn btn-primary"  onclick="open_modal_confirm('컨텐츠를 등록할까요?');">
                            등록
                        </button>
                    </div>
                </div>
...
// 	}
	...
	if(res.result == 'success'){
		console.log(res);
		open_modal_replace(`./contentEdit?idx=\${res.idx}`, "새로운 컨첸츠가 등록되었습니다.");
	}else{
		if(res.error_code){
