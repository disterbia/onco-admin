                ...
                <div class="container content_wrap">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-between">
                            <h3 class="h3"><button class="btn btn_back" onclick="history.back();"><i class="bi bi-arrow-left"></i></button>사용자 상세</h3>
                        ...
                        <div class="col-12">
                            <ul class="list_style_1">
                                ...
                                <li class="mtDiagnosisClass">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="병원명 입력" id="mtHospital" value="${member.mtHospital }">
                        ...
                        <div class="col-12">
                            ...
                            <div class="btn_wrap">
                                <div class="btn_wrap">
                                    ...
                                    <button class="btn btn-danger mr-3" onclick="open_modal_confirm2('해당 회원을 탈퇴처리할까요?')">탈퇴</button>
...
async function update_member(){
	...
	try{
		...
		if(res.result == 'success'){
			console.log(res);
			open_modal_replace(`./memberList`, "회원 정보가 변경되었습니다.");
		}else{
			if(res.error_code){
...
async function delete_member(){
	...
	try{
		...
		if(res.result == 'success'){
			console.log(res);
			open_modal_replace(`./memberList`, "회원이 탈퇴처리되었습니다.");
		}else{
			if(res.error_code){
				console.log(res.error_code, res.error_detail);
				open_modal_alert(res.error_code, res.error_detail);
