    ...
    <div class="container content_wrap">
        <div class="row">
            <div class="col-12 d-flex justify-content-between">
                <h3 class="h3"><button class="btn btn_back" onclick="history.back();"><i class="bi bi-arrow-left"></i></button>${notice.ntTitle }</h3>                
            </div>    
            <div class="col-12">     
                <hr class="hr">
                <div class="message_body">  
                    ...
                    <div class="mt-5">
                        ...
                        <button class="btn btn-primary" onclick="location.href='./noticeEdit?idx=${notice.idx}'">관리</button>
                    </div>
