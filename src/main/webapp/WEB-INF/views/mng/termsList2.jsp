...
<script>
    ...
    $(".m_header_center").text("개인정보처리방침 관리");
</script>
...
<div class="wrap">
    <div class="container content_wrap">
        <form  action="" method="" onSubmit="return false">
            <div class="row">
                <div class="col-12">
                    <h3 class="h3">개인정보처리방침 목록</h3>
	                <button type="button" class="btn btn-light btn-sm position-absolute" onclick="location.href='./termsForm?ttType=2'">+ 개인정보처리방침 등록</button>  
                </div>                
