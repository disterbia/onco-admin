...
var haveSearchValue = false, haveSearchFilter = false, haveSearchFilter2 = false, haveSearchFilter3 = false, haveSearchType = false, haveSearchType2 = false, haveSearchType3 = false, haveDatePicker = false, haveDatePicker2 = false, 
...
function make_search_path(path){
		...
		let search_value = null, search_filter = null, search_filter2 = null,  search_filter3 = null, search_type = null, search_type2 = null, search_type3 = null, search_sdate = null, search_edate = null, search_sdate2 = null, search_edate2 = null, search_day = null, search_group = null;
		...
		if(haveSearchFilter3){
			search_filter3 = $('#search_filter3').val();
		}
		
		if(haveSearchType){
			search_type = $('#search_type').find('.on').val();
		}
		
		if(haveSearchType2){
			search_type2 = $('#search_type2').find('.on').val();
		}
		
		if(haveSearchType3){
			search_type3 = $('#search_type3').find('.on').val();
		}
		...
		if(search_filter2 != 'all' && search_filter2 != null){
			path += param_cnt == 0 ? `?search_filter2=${search_filter2}` : `&&search_filter2=${search_filter2}`;
			param_cnt++;
		}
		
		if(search_filter3 != 'all' && search_filter3 != null){
			path += param_cnt == 0 ? `?search_filter3=${search_filter3}` : `&&search_filter3=${search_filter3}`;
			param_cnt++;
		}
		...
		if(search_type3 != '' && search_type3 != null){
			path += param_cnt == 0 ? `?search_type3=${search_type3}` : `&&search_type3=${search_type3}`;
			param_cnt++;
		}
		...
		if(search_sdate != null && search_sdate_selected != null){
			path += param_cnt == 0 ? `?search_sdate=${search_sdate}` : `&&search_sdate=${search_sdate}`;
			param_cnt++;
		}
		
		if(search_edate != null && search_edate_selected != null){
